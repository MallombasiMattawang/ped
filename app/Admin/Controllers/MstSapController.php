...
class MstSapController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->tools(function ($tools) {
            $tools->append('<a href="/ped-panel/import-sap" class="btn btn-danger btn-sm"><i class="fa fa-upload"></i>&nbsp;&nbsp;  Import Reporting SAP</a>');
    ...
    public function importSap(Content $content)
    {
        return $content
            ->title('Import Tabel SAP')
            ->body(new importSap());
    }
}
