...
class addActual extends Form
{
    ...
    public function handle(Request $request)
    {
        ...
        // }
        $progress_actual = ($actual_volume / $listActivity->volume) * 100;
       
        $progress_actual = Round($progress_actual, 1);
        if ($progress_actual >= 100) {
            $progress_actual = 90;
        }
        $progress_bobot =  ($progress_actual / 100) * $request->bobot;
