        ...
        <div class="col-md-6">
            <div class="box box-default">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-tag"></i> Penentuan WASPANG dan TIM UT</h3>
                </div>
                <div class="box-body">
                    @if ($errors->any())
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($lists as $list)
                                ...
                                <tr>
                                    ...
                                    @if ($supervisi->task == 'PENENTUAN WASPANG DAN TIM UT')
                                        <td> <input type="number" class="form-control jumlah" name="bobot[]"
                                                value="{{ $list->bobot }}" readonly> </td>
                                        <td> <input type="number" class="form-control" name="volume[]"
                                                value="{{ $list->volume }}" readonly> </td>
                                        <td> <input type="text" class="form-control" name="satuan[]"
                                                value="{{ $list->satuan }}" readonly> </td>
                                    @else
                            ...
                            @if ($supervisi->task == 'PENENTUAN WASPANG DAN TIM UT')
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" placeholder="Total" name="total_bobot"
