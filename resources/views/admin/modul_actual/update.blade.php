                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th width="16%" rowspan="2" class="text-center bg-gray disabled color-palette"> <br> List
                                    Activity </th>
                                <th width="16%" colspan="3" class="text-center bg-yellow active color-palette">BASELINE
                                </th>
                                <th width="16%" colspan="3" class="text-center bg-maroon active color-palette">PLAN
                                </th>
                                <th width="16%" colspan="3" class="text-center bg-aqua active color-palette">PROGRESS
                                    ACTUAL
                                </th>
                                <th width="16%" colspan="3" class="text-center bg-green active color-palette"> ACTUAL
                                </th>
                                <th width="16%" rowspan="2" class="text-center bg-aqua active color-palette">ACTION ACTUAL
                                </th>
                            ...
                            @foreach ($lists as $list)
                                ...
                                <tr>
                                    ...
                                    <td class=" text-center">
                                        {{ $list->actual_start ? Round($list->actual_progress, 1) . '%' : '' }} </td>
                                    <td class="text-center"> {{ $list->actual_durasi }} </td>
        
                                    <td class="text-center">
                                        {{ $list->actual_start ? date('d F Y', strtotime($list->actual_start)) : '' }} </td>
                                    <td class="text-center">
                                                ...
                                                @if ($list->actual_status == 'belum' || $list->actual_task == null || $list->actual_task == 'REJECTED')
                                                    ...
                                                    @if ($cek_ut == 1 && $list->activity_id == 22)
                                                        <a href="{{ url('ped-panel/administrasi-generate?id=' . $list->project_id) }}"
                                                            class="btn btn-warning"><i class="fa fa-file-o"></i>&nbsp;&nbsp;
